...
urlpatterns = [
    ...
    path('task_completed_cancellation/', views.task_completed_cancellation, 
         name='task_completed_cancellation'),
    path('task_performer_cancellation/', views.task_performer_cancellation, 
         name='task_performer_cancellation'),
    path('task_verified_cancellation/', views.task_verified_cancellation, 
